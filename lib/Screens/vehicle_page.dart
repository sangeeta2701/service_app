...
class VehiclePage extends StatefulWidget {
  const VehiclePage({Key? key, required this.vehicleNo}) : super(key: key);
...
class _VehiclePageState extends State<VehiclePage> {
  ...
  void initState() {
    ...
    Provider.of<VehicleProvider>(context, listen: false)
        .fetchVehicleServices(widget.vehicleNo);
  }
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: vehicleProvider.isVehicleServiceLoader
                    ...
                    : Column(
                        children: [
                          ...
                          vehicleProvider.isVehicleFound
                              ? Padding(
                          ...
                          if (!vehicleProvider.isVehicleFound)
                            Padding(
                              padding: const EdgeInsets.only(top: 15.0),
                              child: Container(
                                height: 45,
                          ...
                          vehicleProvider.isVehicleFound
                              ? serviceListContainer(vehicleProvider)
                              : SizedBox(),
                        ],
                      ),
              ),
  ...
  SizedBox serviceListContainer(VehicleProvider provider) {
    return SizedBox(
      height: 500,
      child: ListView.builder(
        itemCount: provider.serviceCount,
        itemBuilder: (context, index) {
          Service data = provider.getServices[index];
